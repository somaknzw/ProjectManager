...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.kyana.projectmanager.R.layout.activity_main);

        //realmを開く
        realm = Realm.getDefaultInstance();
        ListView = (ListView)findViewById(com.kyana.projectmanager.R.id.listView);
    ...
    public void setProjectList(){
        ...
        ProjectAdapter adapter = new ProjectAdapter(this, com.kyana.projectmanager.R.layout.project_title_layout, items);
    ...
    public void create(View v){
        ...
        final View view = inflater.inflate(com.kyana.projectmanager.R.layout.dialog_1, null);
...
//ＯＫボタン設定
        builder.setPositiveButton("OK",new DialogInterface.OnClickListener(){
            public void onClick(DialogInterface dialog, int which){
                ...
                titleEditText2 = (EditText) view.findViewById(com.kyana.projectmanager.R.id.titleEditText2);
